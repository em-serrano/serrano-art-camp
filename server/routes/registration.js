...
router.post('/', limiter, async (req, res) => {
    try {
      ...
      formData.registrationInfo.camperName = sanitizeInput(formData.registrationInfo.camperName);
      formData.registrationInfo.parentName = sanitizeInput(formData.registrationInfo.parentName);
      formData.registrationInfo.email = sanitizeInput(formData.registrationInfo.email);
      ...
      const registration = new Registration({
        ...
        dietaryNeeds: Object.keys(formData.dietaryNeeds)
