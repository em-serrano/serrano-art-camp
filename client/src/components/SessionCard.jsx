...
const SessionCard = ({ session }) => {
  ...
  return (
    <div
      ...
      className="relative h-[450px] w-full max-w-[320px] mx-auto cursor-pointer perspective"
    >
      <motion.div
      ...
      >
        {/* FRONT SIDE */}
        <div className="absolute inset-0 rounded-[2rem] p-8 flex flex-col justify-between items-center text-center bg-[#f5f5f7] backface-hidden">
        ...
        {/* BACK SIDE */}
        <div className="absolute inset-0 rounded-[2rem] p-8 flex flex-col justify-between items-center text-center bg-[#1e1e2e] backface-hidden rotate-y-180 shadow-2xl">
