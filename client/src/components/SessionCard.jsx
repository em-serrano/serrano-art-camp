...
const SessionCard = ({ session }) => {
  ...
  return (
    <div
      className="relative h-[450px] w-full max-w-[320px] cursor-pointer perspective group mx-auto"
      ...
      >
        ...
        >
          ...
          <div className="z-10">
            ...
            <p className="text-medium font-medium italic">Monday — Friday</p>
            <p className="text-medium font-medium italic">9:00am — 12:35pm</p>
          </div>

          <div className="z-10 w-full">
            <div className="text-2xl font-black text-[#4c4f69]">
              $250<span className="text-sm font-light text-[#9ea0ad]">/wk</span>
            </div>
            <p className="mt-4 text-[#eba0ac] text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2">
              {/* <span className="w-1 h-1 bg-[#eba0ac] rounded-full animate-ping" /> */}
              Click to View Projects
            </p>
          </div>
        </div>

        {/* BACK SIDE - "Tokyo Night" */}
        <div
        ...
        >
            ...
            <ul className="space-y-3 text-left inline-block">
              {session.projects.map((proj, i) => (
                <li key={i} className="flex items-center text-lg text-[#a6adc8]">
                  <span className="text-[#b4befe] mr-3 font-mono">0{i+1}</span>
                  {proj}
                </li>
              ))}
            </ul>
          ...
          <p className="text-[#585b70] text-[10px] font-bold uppercase tracking-[0.2em] z-10">
            Back to Pricing
          </p>
        </div>
      </motion.div>
