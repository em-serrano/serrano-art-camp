    ...
    <section className="preference-section">
      ...
      <div className="activities-content">
        ...
        <div className="pricing-cards">
          {/* Week 1 Card */}
          <div
            className={`pricing-card with-artist-example ${
              week1Full ? "session-full" : ""
            }`}
          >
            ...
            <div className="card-content">
              <h3 className={week1Full ? "full-session-title" : ""}>
                Week 1: "Back to Nature"
              </h3>
              <div className="price">
                $250
                <span>/week (includes art supplies, materials, and snack)</span>
              </div>
              ...
              {week1Full && (
                <p className="waitlist-text">
                  Join our waitlist by emailing us at <strong>Email:</strong>{" "}
                  <a
                    href="mailto:serranoartcamp@gmail.com"
                    className="text-decoration-none lead full-email"
                  >
          ...
          >
            <div className="artist-example-banner">
              ...
              <div className="artist-overlay">
                <span>
                  Breeze Rustling Through Fall Flowers by Alma Woodsey Thomas
                </span>
              </div>
            </div>
            <div className="card-content">
              <h3 className={week2Full ? "full-session-title" : ""}>
              ...
              {week2Full && (
                <p className="waitlist-text">
                  ...
                  <strong>info@serranoartcamp.com</strong>
                </p>
              )}
            </div>
          </div>
      ...
      <div className="form-section camp--details">
        ...
        <ul>
          ...
          <li>
            Students will hold an art show at 12:10pm on Friday of each week
          </li>
          <li>
            Weekly sessions are limited to 15 artists - first come first serve
            basis
          </li>
